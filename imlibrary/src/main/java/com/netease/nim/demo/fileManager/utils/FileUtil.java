package com.netease.nim.demo.fileManager.utils;
...
public class FileUtil {
    ...
    public static int getFileTypeImageId(Context mContext, String fileName) {
        ...
        if (checkSuffix(fileName, new String[]{"doc", "docx"})) {
            id = R.drawable.file_ic_session_word;
        } else if (checkSuffix(fileName, new String[]{"ppt", "pptx"})) {
            id =  R.drawable.file_ic_session_ppt;
        } else if (checkSuffix(fileName, new String[]{"xls", "xlsx"})) {
            id = R.drawable.file_ic_session_excel;
        } else if (checkSuffix(fileName, new String[]{"pdf"})) {
            id = R.drawable.file_ic_session_pdf;
        } else if (checkSuffix(fileName, new String[]{"zip","7z"})) {
            id = R.drawable.file_ic_session_zip;
        } else if(checkSuffix(fileName, new String[]{"rar"})){
            id = R.drawable.file_ic_detail_rar;
        }else if (checkSuffix(fileName, new String[]{"htm","html"})) {
            id = R.drawable.file_ic_session_html;
        }else if (checkSuffix(fileName, new String[]{"txt","log"})) {
            id = R.drawable.file_ic_session_txt;
        }else if (checkSuffix(fileName, new String[]{"mp4"})) {
            id = R.drawable.file_ic_session_mp4;
        }else if (checkSuffix(fileName, new String[]{"mp3"})) {
            id = R.drawable.file_ic_session_mp3;
        }else
            id = R.drawable.file_ic_session_txt;
        return id;
    }
