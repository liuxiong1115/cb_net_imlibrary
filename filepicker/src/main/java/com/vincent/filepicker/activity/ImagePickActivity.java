...
public class ImagePickActivity extends BaseActivity {
    ...
    public static final String IS_ONLY_SINGLE = "isOnlySingle";
    ...
    //仅单选
    private boolean isOnlySingle = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isOnlySingle  = getIntent().getBooleanExtra(IS_ONLY_SINGLE, false);
        initView();
    }
    ...
    private void initView() {
        ...
        mAdapter = new ImagePickAdapter(this, isNeedCamera, isNeedImagePager, isOnlySingle , mMaxNumber);
