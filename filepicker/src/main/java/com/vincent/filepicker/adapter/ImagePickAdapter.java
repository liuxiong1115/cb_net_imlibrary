...
public class ImagePickAdapter extends BaseAdapter<ImageFile, ImagePickAdapter.ImagePickViewHolder> {
    ...
    public ImagePickAdapter(Context ctx, boolean needCamera, boolean isNeedImagePager,boolean onlySingle, int max) {
        this(ctx, new ArrayList<ImageFile>(), needCamera, isNeedImagePager, onlySingle , max);
    }

    public ImagePickAdapter(Context ctx, ArrayList<ImageFile> list, boolean needCamera, boolean needImagePager, boolean onlySingle, int max) {
        super(ctx, list);
